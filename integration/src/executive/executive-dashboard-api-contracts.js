...
export const RolePermissions = Object.freeze({
  ...
  [ApiRoles.CUSTOMER]: [
    ...
    'customer:auth:oidc:start',
    'customer:auth:oidc:callback',
...
export const RouteDefinitions = Object.freeze([
  ...
  { method: 'POST', path: '/api/v1/customer/auth/oidc/start', permission: 'customer:auth:oidc:start' },
  { method: 'GET', path: '/api/v1/customer/auth/oidc/callback', permission: 'customer:auth:oidc:callback' },
