...
| --- | --- | --- | --- | --- | --- |
| ECR-R1 | Launch-critical runtime state remains insufficiently durable/restorable beyond governance artifact HEAD durability. | CRITICAL | Certification blocker | docs/reviews/atlas-production-readiness-review-prr-2026-07-05.md; docs/reviews/ovp-001-revalidation-after-orp-r-002-2026-07-05.md | Demonstrate runtime-state restoration procedure and record restore evidence. |
